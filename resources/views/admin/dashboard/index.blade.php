                ...
                <div class="card-body">
                    <table class="table  text-center" border="1" style="width: 100%">
                        ...
                        <thead class="table-dark">
                            <tr>
                                <th class="text-uppercase text-warning text-xxs  opacity-7">Order_ID
                                </th>
                                <th class="text-uppercase text-warning text-xxs  opacity-7 ps-2">Date
                                </th>
                                <th class="text-center text-uppercase text-warning text-xxs  opacity-7">
                                    Customer
                                    Name</th>
                                <th class="text-center text-uppercase text-warning text-xxs  opacity-7">
                                    Discount
