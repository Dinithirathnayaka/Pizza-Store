...
<div class="leftsummary">
   ...
   <div class="row"><div class="col-4">Order_ID :</div><div class="col-5">001</div></div> 
    <div class="row"><div class="col-4">Date :</div><div class="col-5">2023/08/24</div></div>
    <div class="row"><div class="col-4">Customer Name :</div><div class="col-5">Dinithi</div></div>
    <div class="row"><div class="col-4">Telephone Number :</div><div class="col-5">0570000000</div></div>
    <div class="row"><div class="col-4">Discount :</div><div class="col-5">3%</div></div>
    <div class="row"><div class="col-4">Total Price :</div><div class="col-5">3000.00</div></div>
    ...
    <table class="table  text-center" border="2" style="width: 100%">
        ...
        <thead>
            ...
            <tbody>
                <tr>
                    <td>
                        <img src="{{ asset('images/pasta-1.jpg') }}" class="productimg" alt="product"></td>
                    <td>001</td>
                    <td>Pasta</td>
                    <td>10%</td>
                    <td>1000.00</td>
