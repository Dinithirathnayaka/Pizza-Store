 ...
 <div class="registerForm">
     <div class="registertext text-center">{{ __('REGISTER') }}</div>
         ...
         <form method="POST" action="{{ route('register') }}">
             ...
             <div class="mb-3">
                 <label for="password-confirm" class="mb-2" style="color:#808080">{{ __('Confirm Password') }}</label>
             ...
             <div class="mx-auto d-block text-center mb-3">
                <label class="form-check-label" for="signup" style="color: #fff;margin-right:10px">
                 ...
                 </label><span><a href="{{ route('login') }}" style="text-decoration: none">Sign In</a></span></div>
